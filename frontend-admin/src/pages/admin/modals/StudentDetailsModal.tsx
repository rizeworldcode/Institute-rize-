...
export function StudentDetailsModal({ student, onClose, onDelete }: any) {
   ...
   const [invoiceModalState, setInvoiceModalState] = useState<{ isOpen: boolean; paymentIndex?: number }>({ isOpen: false });
   ...
   return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
         ...
         <div className="relative w-full max-w-6xl max-h-[90vh] bg-[#f8fafc] rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <div className="flex items-center justify-between px-8 py-5 bg-white border-b border-neutral-100 shrink-0">
               ...
               <div className="flex items-center gap-3">
                  <button 
                     onClick={() => setInvoiceModalState({ isOpen: true })} 
         ...
         {invoiceModalState.isOpen && (
            <StudentInvoiceModal 
               student={student}
               initialPaymentIndex={invoiceModalState.paymentIndex}
